...
export default function Login(props) {
	...
	return (
    <Popup isOpen={props.isOpen} onClose={props.onClose} onEscape={props.onEscape} onLayout={props.onLayout} >
  		<div className="login-form">
  			<form className="form form_popup" action="#" onSubmit={handleSubmit}>
  				...
  				<input id="#login" className="form__input form__input_type_text form__input_popup" placeholder="Логином служит адрес вашей эл. почты" autoComplete="user-name" required />
